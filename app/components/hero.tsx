    ...
    >
      ...
      <div className="relative z-10 h-screen w-full bg-transparent flex flex-col justify-center items-center px-[5%]">
        <motion.div
          ...
          transition={{ duration: 1, delay: 0.5 }}
          className="bg-white w-3/4 md:w-2/4 flex-col md:flex-row p-3 rounded-lg flex justify-around items-center relative z-10 tracking-tighter text-2xl md:text-74xl"
        >
          <Image src={PataCoinImg} width={150} alt="Pata coin" />
          <div className="flex flex-col">
            <p className="text-sm font-medium pb-3">La cryptocurrency de latam</p>
            <button
              type="button"
